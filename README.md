...
<body>
  ...
  <script>
    ...
    form.addEventListener('submit', () => {
      ...
      setTimeout(() => { btn.disabled = false; btn.textContent = '匿名提交'; }, 8000);
    });
  </script>
</body>
</html>
